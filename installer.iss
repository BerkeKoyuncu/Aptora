...
#define MyAppExeName "run.bat"
  ...
  #define ClientBuildDir "client\installer-dist"
#endif
...
SetupIconFile=client\public\aptora.ico
...
Source: "{#ClientBuildDir}\*"; DestDir: "{app}\client\dist"; Flags: ignoreversion recursesubdirs createallsubdirs
Source: "run.bat"; DestDir: "{app}"; Flags: ignoreversion
Source: "run-backend.bat"; DestDir: "{app}"; Flags: ignoreversion
